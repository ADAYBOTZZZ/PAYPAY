...
const client = makeWASocket({ logger: pino ({ level: 'silent' }), printQRInTerminal: true, auth: state, browser: ["SC By ADAY BOTZ", "Dekstop", "2.0"]})
console.log(color('[ SC BY ADAY STORE ]\n', 'aqua'),color('\nABOUT SC :\n➸ Connecting : Multi Device\n➸ Name Sc: Chilo V2.0\n➸ Creator : adaystore\n\nFOLLOW MY SOSMED :\n➸ Youtube : -`\n➸ Instagram : @aldyyypratamaaa\n\Thanks\n', 'white'))
